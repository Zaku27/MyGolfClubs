...
export const DEFAULT_CLUBS: Omit<GolfClub, 'id'>[] = [
  ...
  { clubType: 'Iron', name: 'Iron', number: '7', length: 37, weight: 424, swingWeight: 'D1', lieAngle: 63, loftAngle: 30, shaftType: 'Steel', torque: 1.9, flex: 'S', distance: 160, notes: '' },
  { clubType: 'Iron', name: 'Iron', number: '8', length: 36.5, weight: 430, swingWeight: 'D1', lieAngle: 63.5, loftAngle: 34, shaftType: 'Steel', torque: 1.9, flex: 'S', distance: 150, notes: '' },
